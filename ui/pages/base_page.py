...
class BasePage(ABC):
    ...
    def find_elements_by_text(self, tag: str, text: str, partial: bool = True) -> List[
    ...
    def wait_for_element_by_text(self, tag: str, text: str, partial: bool = True,
    ...
    def get_div_table_data(self, table_selector: str) -> list[dict]:
        """Универсальный сбор данных из div-таблиц
        ...
        headers = [h.text.strip() for h in rows[0].find_elements(By.XPATH, './div')]
